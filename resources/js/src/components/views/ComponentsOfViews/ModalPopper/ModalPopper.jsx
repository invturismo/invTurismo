...
import { handleFunctionsPopper } from './handleFunctionsPopper';
...
const MainModalPopper = styled.div`
  --color-5x: #110934;
  --color-4x: #29157e;
  --color-3x: #4424d6;
  --color-2x: #8c78e8;
...
const ModalPopper = () => {
  ...
  const handleFunction = handleFunctionsPopper({
    dispatch,
    navigate,
    idRegister,
  });
        ...
        <div className="footer">
          <div className="container">
            ...
            <button
              ...
              onClick={handleFunction[whoFunction]}
            >
              si, {textButton}
            </button>
          </div>
